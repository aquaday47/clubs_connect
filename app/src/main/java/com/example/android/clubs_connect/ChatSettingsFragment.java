 ...
 */
public class ChatSettingsFragment extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        LayoutInflater.from(this.getContext()).inflate(R.layout.fragment_chat_settings, null, false);
    }

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        addPreferencesFromResource(R.xml.chat_pref_visualizer);
